...
export async function getEventBySlug(
  ...
  const { data, error } = await supabase
    ...
    .select(
      ...
      host:users!events_host_id_fkey ( id, username, avatar_url, profile:host_pages!host_profiles_user_id_fkey ( id, display_name, organisation_name, tagline, logo_url, rating_avg ) ),
