      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-950 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-md px-12 space-y-8">
          <div className="flex items-center gap-4 mb-12">
            <Image src="/logo-2.svg" alt="City Culture" width={200} height={50} className="brightness-0 invert" style={{ width: 'auto', height: 'auto' }} priority />
          </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="lg:hidden flex justify-center mb-4">
            <Image src="/logo-2.svg" alt="City Culture" width={180} height={45} style={{ width: 'auto', height: 'auto' }} priority />
          </div>
          ...
          <p className="text-center text-[11px] text-gray-400 font-medium leading-relaxed pt-4">
            Anyone can host events on City Culture. Need access or assistance?
            <br />
            Contact us at{' '}
            <a href="mailto:citycultureteam@gmail.com" className="text-yellow-400 hover:underline">
              citycultureteam@gmail.com
            </a>{' '}
            or WhatsApp{' '}
            <a href="https://wa.me/917411820025" className="text-yellow-400 hover:underline">
              +91 74118 20025
            </a>
          </p>
        </div>
