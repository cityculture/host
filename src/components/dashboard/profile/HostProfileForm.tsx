  ...
  return (
    <div className="space-y-10">
      ...
      <div className="bg-gray-50/50 rounded-2xl p-6 border border-gray-100 flex items-start gap-4">
        ...
        <div>
          <p className="text-xs font-black text-gray-800 uppercase tracking-tight mb-1">Profile is managed by City Culture</p>
          <p className="text-[11px] font-medium text-gray-400 leading-relaxed">
            Your profile, bank details, and verification status are managed by the City Culture team.
